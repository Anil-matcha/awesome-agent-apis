...
- [SandBase](https://github.com/sandbaseai/cli) - Connects OpenClaw to 2,000+ AI tools and 200+ models through a unified MCP interface. The open-source CLI installs and verifies both the [SandBase ClawHub Skill](https://clawhub.ai/joeliu926/skills/sandbase) and an ownership-protected MCP bridge, with exact rollback and `unregister`. `npx -y @sandbaseai/cli connect --client openclaw`
