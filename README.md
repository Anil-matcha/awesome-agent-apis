...
- [OutageDeck Dependency Outage Triage](https://github.com/outagedeck/triage-dependency-outages) - Check live cloud and SaaS incident evidence before changing code. No account, API key, executable, or environment variable required. `openclaw skills install git:outagedeck/triage-dependency-outages@v0.1.0`
